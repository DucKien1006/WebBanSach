<template>
    <div class="wrap-table100">
        ...
        <div class="table">
            ...
            <div class="row" v-for="(item, index) in listData" :class="rowSelected==item.idOrder?'row-selected':''" @dblclick="selectedRow(item)">
                <div class="cell" data-title="Full Name">
                    {{ item.orderCode }}
                </div>
                <div class="cell left" data-title="Age">
                    {{ item.totalPayment }} <span class="unit-price">đ </span>
                </div>
                <div class="cell" data-title="Job Title">
                    {{ enumPaymentType[item.paymentType] }}
                </div>
